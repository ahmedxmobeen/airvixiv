...
const zoomIn = () => {
  setMapZoom((z) => Math.min(z + ZOOM_STEP, MAX_ZOOM));
};

const zoomOut = () => {
  setMapZoom((z) => Math.max(z - ZOOM_STEP, MIN_ZOOM));
};
...
const handleMapWheel = (e) => {
  ...
  setMapZoom((currentZoom) => {
    ...
    setMapPosition((currentPosition) => ({
      x: mouseX - (mouseX - currentPosition.x) * scale,
      y: mouseY - (mouseY - currentPosition.y) * scale,
    }));
